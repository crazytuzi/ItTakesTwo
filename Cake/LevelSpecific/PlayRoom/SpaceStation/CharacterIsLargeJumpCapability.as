...
class UCharacterIsLargeJumpCapability : UCharacterMovementCapability
{
	...
	{	
		...
		const float JumpImpulse = 1150.f;
	...
	void MakeFrameMovementData(FHazeFrameMovement& FrameMoveData, float DeltaTime)
	{
		...
		{	
			...
			VerticalVelocity = JumpData.CalculateJumpVelocity(DeltaTime, bIsHolding, MoveComp.MaxFallSpeed, -MoveComp.GravityMagnitude * 1.15f, MoveComp.WorldUp);

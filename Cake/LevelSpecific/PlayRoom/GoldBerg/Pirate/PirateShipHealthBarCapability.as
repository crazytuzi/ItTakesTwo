...
class UPirateShipHealthBarCapability : UHazeCapability
{
    AHazeActor Enemy;
	...
	UPROPERTY()
	float ShowHealthBarDuration = 5.f;
	...
	void ShowWidgetForPlayer(AHazePlayerCharacter Player)
	{
		...
		Widget.AttachWidgetToComponent(CannonBallDamageableComponent.HealthWidgetAttachComponent);
		Widget.SetWidgetShowInFullscreen(true);
		Widget.SetWidgetRelativeAttachOffset(WidgetPositionOffset+FVector(0,0,700.0f));

...
class UGrindJumpTutorialCapability : UHazeCapability
{
	...
	{
		if (IsActioning(n"ShowGrindJumpTutorial") && Grindcomp.HasActiveGrindSpline())
		{
	...
	{
		if (!IsActioning(n"ShowGrindJumpTutorial")  || Player.IsAnyCapabilityActive(GrindingCapabilityTags::Jump))
		{
	...
	void ShowTutorial()
	{
		...
		PromptThree.Action = ActionNames::MovementJump;
